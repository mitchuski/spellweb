...
const NODES = [
  ...
  { id: "con-privacyvalue", type: "concept", label: "Privacy is Value", domain: "shared", layer: "knowledge", desc: "Core thesis: privacy-preserving architectures keep the value that surveillance alternatives appropriate — value is the share the consent interface lets the subject keep. (The historical 678×–31,000× multiples are retired essay-lineage figures, not current facts.)" },
