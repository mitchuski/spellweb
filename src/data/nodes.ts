...
export const NODES: SpellwebNode[] = [
  ...
  { id: "cast-soulbae", type: "cast", label: "Soulbae 🧙", sigil: "🧙", emoji: "🧙", domain: "mage", layer: "narrative", desc: "The First Mage archetype. Cast roster anchor at V28 (Mage canonical). Mirrors the existing per-soulbae persona; kept here for cast-roster contiguity.", tier: "archetype", vertex: 28 },
  ...
  // ── Workshops (12 = 11 live + 1 placeholder) ──
  ...
  { id: "shop-hall",            type: "workshop", label: "Ceremony Hall", emoji: "⚔️", domain: "shared", layer: "narrative", desc: "Bilateral key ceremonies; BGIN coalition. Gathering shop; no resident Mage yet.", gem: "Lapis", gemColor: "#1e40af", href: "/hall", vertex: 15, tradeQuarter: "gathering", operatorStatus: "partial", artefactName: "Paired Key", artefactRootName: "Bilateral Key", artefactClass: "tool", artefactArchetype: "bilateral", artefactWielder: "both" },
  ...
  { id: "tome-v-the-crafting", type: "document", label: "Tome V — The Crafting", emoji: "📖", domain: "shared", layer: "narrative", desc: "The open tome. Fifteen acts and counting: the First Cloak through the Substrate. The bound knowledge of the City of Mages — every workshop's founding myth is here. Carried as a tome artefact; the Tome V grows as the city does, and walking each Act 1–15 adds a leaf to the carrier's copy.", version: "1.0", artefactName: "Tome V", artefactRootName: "Crafting Tome", artefactClass: "tome", artefactArchetype: "bilateral", artefactWielder: "both" },
  { id: "tome-vi-the-reply", type: "document", label: "Tome VI — The Reply (held open)", emoji: "📖", domain: "shared", layer: "narrative", desc: "The tome held open for the reader to write. Per /tomes page.tsx's six-tome long arc. Sovereigns who walk all Tome IV + V acts carry Tome VI as a blank leaf — their own reply to the City. Future content; placeholder for now.", artefactName: "Tome VI", artefactRootName: "Reply Tome", artefactClass: "tome", artefactArchetype: "bilateral", artefactWielder: "both" },
  ...
  { id: "cast-selene",      type: "cast", label: "Selene 🌕", sigil: "🌕", emoji: "🌕", domain: "shared", layer: "narrative", desc: "The Moon-Mage. PVM V5.4 §14.5 · Selene's Proof. Stratum-walker; orbits the moon-phase cycle through all 7 strata. 'The credential is the orbit. The proof renews twice daily, written in saltwater.' First C-peripatetic attachment of its kind.", tier: "summoned", attachmentKind: "C_peripatetic", divergence: "none", abstractPersonaIds: ["theia", "manaweaver"], castStatus: "anticipated", attribution: "agentprivacy" },
