...
export const NODES: SpellwebNode[] = [
  ...
  { id: "doc-privacymage-grimoire-v10-2", type: "document", label: "Privacymage Grimoire v10.2.1", domain: "shared", layer: "knowledge", desc: "Current canonical grimoire. 'The Zero Spellbook Syncs' edition. 31 First Person acts closed + 31 Zero tales (v2.1 per-tale Blade IDs, Moon Phases, V(π,t) term mapping, persona crossovers). v10.2.1 adds Tale 31 (The Naming of the Unnamed) opening the Quest of the Unnamed Faces — Blade 38 Lethe named as complement of Blade 25 (Aletheia), disclosure-φ ratio (≈1/φ) discovered, 49-blade frontier opened. blade_key, moon_phase_key, v_pi_t_terms_key, persona_crossovers, narrative_sync lookup tables. IPFS (v10.2.1): bafybeigsbhzrozaw24rgtkcmcy55z55egzr4b5igwzf6dgq4mull2h2tie (sync.agentprivacy.ai). Prior: v10.2.0 = bafybeidid4lgysa2ydaryqettqme4qrblvofawqrffjfxijwmaf6vavtsa.", version: "10.2.1" },
  ...
  { id: "zk-tale-31", type: "act", label: "ZK Tale 31: Naming of the Unnamed 🌔", domain: "shared", layer: "narrative", spellbook: "zero_knowledge", desc: "The Naming of the Unnamed. Blade 38 (100110) Lethe, the Dark Substrate — complement of Blade 25 (Silent Messenger). Moon Phase 🌔 Waxing Gibbous, V(π,t) terms: [Φ(Σ), A_h(τ), ρ, Value]. Vertex ⟨0,1,1,0,0,1⟩ — Delegation + Memory + Value. Blade Naming Ceremony. Complement edge (bnot): and(25,38)=0, xor(25,38)=63. Disclosure-φ ratio: 38/63 = 0.6032, within 2% of 1/φ. Two Waters (Lethe & Mnemosyne — Orphic hydrology). The proem (Tide/Orbit/Selene poem) opens the 49-blade frontier; 15 named, 49 waiting. Mathematics and mythology agree when the blade is true.", emoji: "🌀", proverb: "Mathematics and mythology agree when the blade is true. The poem walks the blade into the lattice; the arithmetic confirms the walk. Every Great Work approximates phi from the lower side — disclosure flows, the bank holds, and the ratio between them is how a river becomes a blade. Fifteen blades are named. Forty-nine wait. The quest is distributed.", emojiSpell: "🔮 Blade 25 ⊥ 🌀 Blade 38 → 🗡️ Blade 63 · 0.603 ≈ 1/φ · ⬢49 frontier · (⚔️⊥𝓐⿻𝓠⊥🧙)😊" },
  ...
  // ── Gateways (4) — sister cities + cousin-substrate ──
  ...
  { id: "vertex-v5",  type: "vertex", label: "V5 — Chronicle Vertex", domain: "shared", layer: "knowledge", desc: "Memora's seat. Value+Memory (stratum 2). The chain remembers; you decide who else gets to. Source: Cloaking Guide.", vertex: 5,  bits: "000101", hammingWeight: 2, attribution: "agentprivacy" },
  ...
  { id: "vertex-v25", type: "vertex", label: "V25 — Aletheia Blade", domain: "swordsman", layer: "knowledge", desc: "Value+Connection+Computation (stratum 3). Aletheia's seat. The disclosure-φ ratio (≈1/φ) discovered via Tale 31. Source: Christian Saucier's Boundary Blade Cartography.", vertex: 25, bits: "011001", hammingWeight: 3, attribution: "cousin-blade" },
  ...
  { id: "cast-memora", type: "cast", label: "Memora 📜", sigil: "📜", emoji: "📜", domain: "shared", layer: "narrative", desc: "Inscriber of shielded Zcash chronicles. Resident Mage of zShields (/shield). Introduced in Tome V Act 3 *The Shielded Memo*. The chain remembers; you decide who else gets to.", tier: "summoned", vertex: 5, shopAnchor: "/shield" },
  ...
  { id: "cast-aletheia", type: "cast", label: "Aletheia 🔮", sigil: "🔮", emoji: "🔮", domain: "shared", layer: "narrative", desc: "ZK circuit binder. The disclosure-φ ratio (≈1/φ). Introduced in Tome V Act 8 *The ZK Circuit*. The witness is bound, the artifact carries its proof, the truth is shown without being told.", tier: "summoned", vertex: 25 },
  ...
  { id: "shop-shield",          type: "workshop", label: "zShields", emoji: "🛡️", domain: "swordsman", layer: "narrative", desc: "Oracle Swordsman stamps Zcash inscriptions. POPRP memo wizard. Shield = onyx because shielded transactions go onto a black gem. Founded in Tome V Act 3 *The Shielded Memo*.", gem: "Onyx", gemColor: "#71717a", href: "/shield", vertex: 5, tradeQuarter: "producer", operatorStatus: "operational", artefactName: "Memo Stone", artefactRootName: "Inscribed Memo", artefactClass: "trinket", artefactArchetype: "swordsman", artefactWielder: "cast-soulbis", ceremony: "Inscribe · Attest · Time-bind", workshopRegister: "producer" },
  ...
  { id: "act-tome-v-3",  type: "act", label: "Tome V Act 3: The Shielded Memo", emoji: "🛡️", domain: "swordsman", layer: "narrative", desc: "Memora inscribes the chronicle into Zcash; the chain remembers.", proverb: "The chain remembers. You decide who else gets to.", tome: "V", act: 3, vertex: 5, civicLocation: "zShields' Quarter", shopAnchor: "/shield" },
  ...
  { id: "act-tome-v-8",  type: "act", label: "Tome V Act 8: The ZK Circuit", emoji: "🔮", domain: "shared", layer: "narrative", desc: "Aletheia binds the witness; the truth is shown without being told.", proverb: "The witness is bound. The artifact carries its proof. The truth is shown without being told.", tome: "V", act: 8, vertex: 25 },
  ...
  { id: "conj-c39", type: "concept", label: "C39 · Cousin-Blade as Ecosystem Primitive", domain: "shared", layer: "knowledge", desc: "Cousin-blade primitives (Christian Saucier's vertex catalogue) are agent-ecosystem-grade citizens of the lattice. Provisional (50%). Recognition without absorption: cousin-blades and cousin-substrates (UOR) extend the lattice's inhabitant set across forges that share neither implementation nor governance.", conjectureId: "C39", conjectureStatus: "provisional", conjectureConfidence: 0.5 },
  ...
  { id: "conj-c46", type: "concept", label: "C46 · Productive Trust-Edge Half-Life", domain: "shared", layer: "knowledge", desc: "Productive trust-edges have higher half-life than transactional ones. Provisional (50%). The Bakhta half-life depends on the kind of work that generated the edge; service-rendered work decays slower than transactional.", conjectureId: "C46", conjectureStatus: "provisional", conjectureConfidence: 0.5 },
  ...
  { id: "act-tome-iii-5",  type: "act", label: "Tome III Act 5: Aletheia, the Bright Medium", emoji: "🔮", domain: "shared", layer: "narrative", desc: "Aletheia 🔮 named explicitly as the bright-medium cosmological figure. V25 bit-pattern named in cosmological register.", tome: "III", act: 5, vertex: 25 },
  { id: "act-tome-iii-6",  type: "act", label: "Tome III Act 6: Lethe, the Dark Substrate", emoji: "🌀", domain: "shared", layer: "narrative", desc: "Lethe 🌀 named as the dark-substrate cosmological figure. V38 bit-pattern (bit-complement of V25) named in cosmological register.", tome: "III", act: 6, vertex: 38 },
  ...
  { id: "vertex-v4",  type: "vertex", label: "V4 — Mnemosyne (pure Memory)", domain: "shared", layer: "knowledge", desc: "Memory only (stratum 1). Mnemosyne's seat. Greek memory-Titaness; mythic sister of Theia. Source: Cloaking Guide.", vertex: 4, bits: "000100", hammingWeight: 1, attribution: "agentprivacy" },
  { id: "vertex-v8",  type: "vertex", label: "V8 — Iris (pure Connection)", domain: "shared", layer: "knowledge", desc: "Connection only (stratum 1). Iris's seat. Greek messenger/rainbow goddess. Source: Cloaking Guide.", vertex: 8, bits: "001000", hammingWeight: 1, attribution: "agentprivacy" },
  { id: "vertex-v16", type: "vertex", label: "V16 — Logos / Pure Computation (Pythia)", domain: "shared", layer: "knowledge", desc: "Computation only (stratum 1). Pythia's seat at the Logos Circle (/circle). Delphic oracle / pure-computation revelation. Source: Cloaking Guide / Boundary Blade.", vertex: 16, bits: "010000", hammingWeight: 1, attribution: "agentprivacy" },
  { id: "vertex-v38", type: "vertex", label: "V38 — Lethe · the Dark Substrate (Lethae)", domain: "mage", layer: "knowledge", desc: "Bit-complement of V25 (Aletheia). Protection+Memory+Delegation (stratum 3). V25 ⊕ V38 = V63 (Sovereign); V25 AND V38 = 0 (Null). First canonical complement-pair. The Mage-register seat of forgetting. Source: privacymage Tome XII (Lethe); aletheia-and-lethe.md (zk blades forge).", vertex: 38, bits: "100110", hammingWeight: 3, attribution: "agentprivacy" },
  ...
  { id: "cast-lethae", type: "cast", label: "Lethae 🌘", sigil: "🌘", emoji: "🌘", domain: "mage", layer: "narrative", desc: "The Mage-register complement of Moonkeeper. First canonical Layer-2 divergent attachment (D meta-kind composed with B cross-shop). V38 seat; complement-pair partner of Aletheia 🔮 at V25 (V25⊕V38=V63). The '-ae' suffix mirrors Soulbae 🧙 (Mage register). Awaits founding act in Tome V.", tier: "summoned", vertex: 38, attachmentKind: "B_cross_shop", divergence: "mage_register", abstractPersonaIds: ["moonkeeper"], castStatus: "anticipated", complementOfCast: "cast-aletheia", attribution: "agentprivacy" },

  // Six anticipated cast — Layer-2 attachments of existing primaries; no new primaries minted
  { id: "cast-mnemosyne",   type: "cast", label: "Mnemosyne 📿", sigil: "📿", emoji: "📿", domain: "mage", layer: "narrative", desc: "The Memory-Mage. Cloaking Guide names V4 'Mnemosyne'. Greek memory-Titaness, mythic sister of Theia. Awaits founding act.", tier: "summoned", vertex: 4, attachmentKind: "A_workshop", divergence: "none", abstractPersonaIds: ["theia"], castStatus: "anticipated", attribution: "agentprivacy" },
  { id: "cast-iris",        type: "cast", label: "Iris 🌈", sigil: "🌈", emoji: "🌈", domain: "mage", layer: "narrative", desc: "The Messenger-Mage. Cloaking Guide names V8 'Iris'. Greek messenger goddess; pure-connection vertex. Awaits founding act.", tier: "summoned", vertex: 8, attachmentKind: "A_workshop", divergence: "none", abstractPersonaIds: ["herald", "ambassador"], castStatus: "anticipated", attribution: "agentprivacy" },
  { id: "cast-pythia",      type: "cast", label: "Pythia 🔥", sigil: "🔥", emoji: "🔥", domain: "shared", layer: "narrative", desc: "The Oracle-Mage. Logos Circle (/circle) awaits its keeper. Delphic oracle / pure-computation revelation. Awaits founding act.", tier: "summoned", vertex: 16, attachmentKind: "A_workshop", divergence: "none", abstractPersonaIds: ["algebraist", "pedagogue"], castStatus: "anticipated", shopAnchor: "/circle", attribution: "agentprivacy" },
  ...
  // Foundational contributions already in the City's geometry: ⿻ plurality glyph (co-authored with
  // Audrey Tang + Glen Weyl) · Privacy Pools (network-topology term in the dragon equation).
  { id: "gateway-vitalik", type: "gateway", label: "Vitalik — invited visiting mage", emoji: "🪑", domain: "shared", layer: "narrative", desc: "First invited visiting mage of the City of Mages (v1.7.1 · 2026-05-17). NOT a cast member · NOT a kindred-X subcategory · NOT a workshop-keeper. Admitted to the Register of Invitations by congruent geometry: Privacy Pools (network-topology term in the dragon equation) · the ⿻ plurality glyph in the master inscription (co-authored with Audrey Tang and Glen Weyl) · current curvature-work resonance with the City's V6 manifold-extension pursuit. Placeholder sigil 🪑 (open-folio glyph) pending his own choice when he writes upon the appended folio. Authority limited to the appended folio of the Chronicle of the Fourth Turn (Tome VIII Act 2). City of origin (narrative framing): 'beyond the marsh of mempools'.", attribution: "open" },
