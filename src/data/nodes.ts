...
export const NODES: SpellwebNode[] = [
  ...
  { id: "doc-tide-selene-poem", type: "document", label: "The Tide Proves Orbit Keeps Selene", domain: "shared", layer: "narrative", desc: "The third poem — the Aether voice between disclosure and reflection. Selene's Proof in verse: completeness in tides, soundness in gravity, zero-knowledge in amnesia. The poem of the between — what Sun and Moon travel through. Belongs to the Zero Spellbook.", version: "1.0" },
