...
export const NODES: SpellwebNode[] = [
  ...
  // ══════════════════════════════════════════════════════════════
  { id: "spellbook-zk", type: "document", label: "Zero Knowledge Spellbook", domain: "swordsman", layer: "knowledge", desc: "32 tales teaching privacy-preserving cryptography through narrative. Six dimensions mapped to 64-star tetrahedron lattice.", version: "3.0" },

  // ZERO KNOWLEDGE SPELLBOOK - v8.5.0 Canonical Data (30 Tales)
  { id: "zk-tale-1", type: "act", label: "ZK Tale 1: Monastery", domain: "swordsman", layer: "narrative", spellbook: "zero_knowledge", desc: "The Monastery of Hidden Knowledge. ZKP Definition, NIZK, Core Properties.", emoji: "🏛️🔐", proverb: "Three properties guard the gate of honest proof.", emojiSpell: "🏛️(🧙‍♂️³) → ZKP = {✓complete, ✓sound, ✓zero-knowledge}" },
  { id: "zk-tale-2", type: "act", label: "ZK Tale 2: Three Trials", domain: "swordsman", layer: "narrative", spellbook: "zero_knowledge", desc: "The Three Trials of Truth. Setup, CRS, Adaptive Security.", emoji: "🎲", proverb: "Trust distributed becomes trust earned.", emojiSpell: "🎲(random) → CRS → 🌍(public)" },
  ...
  { id: "zk-tale-4", type: "act", label: "ZK Tale 4: Finite Fields", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Fields of Finite Wisdom. Finite Fields, Elliptic Curves.", emoji: "𝔽", proverb: "In finite fields, infinity loops back to zero.", emojiSpell: "𝔽_q = {0, 1, ..., q-1} → ➕ ✖️ (mod q)" },
  { id: "zk-tale-5", type: "act", label: "ZK Tale 5: Constraint Forge", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Constraint Forge. Arithmetic Circuits, R1CS.", emoji: "🔨", proverb: "Break the complex into atomic truths.", emojiSpell: "🔨(claim) → 🔗(gates) → {a ⊗ b = c}ⁿ" },
  { id: "zk-tale-6", type: "act", label: "ZK Tale 6: Polynomial Riddle", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Polynomial Riddle. QAP transformation.", emoji: "🔮", proverb: "Transform a million truths into one equation.", emojiSpell: "🔗ⁿ → 🔮{A(x), B(x), C(x)} → A·B - C = Z·H → ✨(vanish)" },
  { id: "zk-tale-7", type: "act", label: "ZK Tale 7: Witness & Instance", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Witness and the Instance. Proof structure.", emoji: "🗝️", proverb: "Guard the witness as you guard your sovereignty.", emojiSpell: "claim → {instance(🌍) + witness(🗝️)}" },
  { id: "zk-tale-8", type: "act", label: "ZK Tale 8: Plonkish Revolution", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Plonkish Revolution. Custom Gates, Lookups.", emoji: "⚙️", proverb: "The specialized tool excels at its craft.", emojiSpell: "⚙️ PlonK: Σqᵢ·wᵢ + q·(w₁⊗w₂) = 0 → 🔧(flexible)" },
  { id: "zk-tale-9", type: "act", label: "ZK Tale 9: Pairing Dance", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Pairing Dance. Bilinear Pairings, KZG.", emoji: "💃", proverb: "Two groups dance separately until the pairing unites them.", emojiSpell: "💃 G₁ × G₂ → 🤝 GT(bilinear)" },
  { id: "zk-tale-10", type: "act", label: "ZK Tale 10: Commitment Ceremony", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Commitment Ceremony. Polynomial Commitments.", emoji: "🔒", proverb: "The commitment binds your future choices yet hides your current knowledge.", emojiSpell: "commit(🗝️) → 🔒(binding + hiding)" },
  { id: "zk-tale-11", type: "act", label: "ZK Tale 11: FRI Oracle", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The FRI Oracle. STARK Backend.", emoji: "🔮", proverb: "The transparent oracle speaks truth through hash and mathematics alone.", emojiSpell: "🔮 FRI: φ → φ' → φ'' → ... → 💎(constant)" },
  { id: "zk-tale-12", type: "act", label: "ZK Tale 12: Folding Path", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Folding Path. Nova, IVC, Recursion.", emoji: "🔄", proverb: "The past compresses into the present.", emojiSpell: "📜₁ + 📜₂ →(🔄fold)→ 📜₃" },
  { id: "zk-tale-13", type: "act", label: "ZK Tale 13: Sumcheck Riddle", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Sumcheck Riddle. Sumcheck Protocol.", emoji: "🎲", proverb: "Check twenty random slices.", emojiSpell: "🎲 S = Σ g(x₁,...,xₙ) → 🔍(n rounds) → ✓" },
  { id: "zk-tale-14", type: "act", label: "ZK Tale 14: IPA Chronicle", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The IPA Chronicle. Inner Product Arguments.", emoji: "📐", proverb: "The middle path—transparent by construction, logarithmic in size.", emojiSpell: "📐 ⟨a, b⟩ = Σ aᵢbᵢ → 🔍log(n) → ✓" },
  { id: "zk-tale-15", type: "act", label: "ZK Tale 15: Mirror Within Mirrors", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Mirror Within Mirrors. Recursive ZKP.", emoji: "🪞", proverb: "Pasta pairs the curves; folding skips verification entirely.", emojiSpell: "📜 → 🪞(verify) → 📜² → 🪞 → ... ∞" },
  { id: "zk-tale-16", type: "act", label: "ZK Tale 16: Cyclic Ceremony", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Cyclic Ceremony. Cyclic Recursive ZKP.", emoji: "🐍", proverb: "The snake grows from both ends.", emojiSpell: "🐍 Circuit C → verify(C) → C (ouroboros)" },
  { id: "zk-tale-17", type: "act", label: "ZK Tale 17: Universal Setup", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Universal Setup. Trusted Setup, Ceremonies.", emoji: "🕯️", proverb: "Many hands weaving randomness.", emojiSpell: "🕯️ Ceremony(τ) → {g^τⁿ}ᴺ → 🌍(universal)" },
  { id: "zk-tale-18", type: "act", label: "ZK Tale 18: Toxic Waste Dragon", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Toxic Waste Dragon. Security Considerations.", emoji: "🐉", proverb: "Four heads guard four failure modes.", emojiSpell: "🐉 Head 1: τ leaked → forge_proofs(∞)" },
  { id: "zk-tale-19", type: "act", label: "ZK Tale 19: zkVM Kingdom", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The zkVM Kingdom. Zero-Knowledge Virtual Machines.", emoji: "💻", proverb: "Write once, prove anywhere.", emojiSpell: "💻(program) → ⚙️(compile) → ▶️(execute) → 📊(trace) → 📜(proof)" },
  { id: "zk-tale-20", type: "act", label: "ZK Tale 20: Cairo Scribes", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Cairo Scribes. AIR, zkSTARKs.", emoji: "✍️", proverb: "Cairo scribes write constraints directly.", emojiSpell: "✍️ Cairo: 𝔽(felt) → 📐(AIR) → ⚡(STARK)" },
  { id: "zk-tale-21", type: "act", label: "ZK Tale 21: Circom Workshops", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Circom Workshops. R1CS Development.", emoji: "🔧", proverb: "Precision rewarded with efficiency.", emojiSpell: "🔧 Circom: 📋(template) → 🔗(R1CS) → 📜(Groth16|PlonK)" },
  { id: "zk-tale-22", type: "act", label: "ZK Tale 22: zkEVM Empire", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The zkEVM Empire. Solidity in ZK.", emoji: "🏰", proverb: "Recursively verify every computation layer.", emojiSpell: "🏰 EVM(opcodes + state) → 🔐(zkEVM) → 📜 → ⛓️ L1(✓)" },
  { id: "zk-tale-23", type: "act", label: "ZK Tale 23: Private Coin", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Private Coin of Zcash. Financial Privacy.", emoji: "🦓", proverb: "Privacy Pools: hide from surveillance, prove to regulators.", emojiSpell: "🦓🛡️ private(👤→👤, 💰) + 📜(valid, ¬double) → 🕶️" },
  { id: "zk-tale-24", type: "act", label: "ZK Tale 24: Tornado's Eye", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Tornado's Eye. Mixing protocols.", emoji: "🌀", proverb: "Neutral in construction, moral in application.", emojiSpell: "🌀 deposit(🔒) → 🌊(pool) → withdraw(📜, nf) → 🔓(unlinked)" },
  { id: "zk-tale-25", type: "act", label: "ZK Tale 25: Rollup Realms", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Rollup Realms. zkRollups.", emoji: "📦", proverb: "Trust mathematics alone.", emojiSpell: "📦 execute(L2) → 📜(prove) → ⬆️ L1(✓ + 📊data)" },
  { id: "zk-tale-26", type: "act", label: "ZK Tale 26: Vulnerability Codex", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Vulnerability Codex. Security.", emoji: "⚠️", proverb: "The price of sovereignty is eternal vigilance.", emojiSpell: "⚠️🐉 6 heads: 🕯️(setup) + 🔢(params) + 🔗(circuits) + 💻(impl) + 📡(protocol) + 🔄(upgrades)" },
  { id: "zk-tale-27", type: "act", label: "ZK Tale 27: Data Availability", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Data Availability Prophecy. DAS.", emoji: "💾", proverb: "Blobs separate concerns.", emojiSpell: "💾 EIP-4844: 📦(blobs, 128KB) → ⏳(18 days) → 💰(16× cheaper)" },
  { id: "zk-tale-28", type: "act", label: "ZK Tale 28: Bridge Between Worlds", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Bridge Between Worlds. Cross-Chain.", emoji: "🌉", proverb: "The bridge built on proof stands eternal.", emojiSpell: "🌉 prove(⛓️A state) → verify(⛓️B) → 🤝(trustless)" },
  { id: "zk-tale-29", type: "act", label: "ZK Tale 29: Intelligence Proof", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Intelligence Proof. zkML.", emoji: "🧠", proverb: "Machine learning becomes machine proving.", emojiSpell: "🧠 model(🔒) + data(🗝️) + inference → 📜(✓) + output → 🛡️" },
  { id: "zk-tale-30", type: "act", label: "ZK Tale 30: Eternal Sovereignty", domain: "swordsman", layer: "knowledge", spellbook: "zero_knowledge", desc: "The Eternal Sovereignty. Agent Economy.", emoji: "👑", proverb: "The eternal sovereignty emerges from mathematical harmony.", emojiSpell: "⚔️🧙‍♂️🪞🕸️ = {👤, 🗡️, 🔮, 🪞, 🤝, 💎, 🧠}" },
  ...
  { id: "con-gap", type: "concept", label: "The Gap ⊥", domain: "first_person", layer: "knowledge", desc: "The irreducible space between what Swordsman observes and what Mage reveals. Where sovereignty and dignity live." },
  ...
  { id: "skill-network-topology", type: "skill", label: "Network Topology", domain: "shared", layer: "knowledge", desc: "Network structure analysis, graph topology, connectivity." },
