...
// ══════════════════════════════════════════════════════════════
  ...
  { source: "gateway-hearthold",          target: "key-hearthold-citykey",       type: "references" },
  { source: "gateway-hearthold",          target: "concept-workshop-trust-task", type: "relates_to" },
  { source: "act-tome-x-1",               target: "gateway-hearthold",           type: "references" },
  { source: "act-tome-x-1",               target: "concept-the-hearth",          type: "introduces" },
  { source: "act-tome-x-1",               target: "concept-hearthold-warden",    type: "teaches" },
  { source: "act-tome-x-1",               target: "concept-hearthold-witness",   type: "teaches" },
  { source: "act-tome-x-1",               target: "concept-hearthold-sovereign", type: "teaches" },
  { source: "act-tome-x-1",               target: "conj-c94",                    type: "introduces" },
  { source: "act-tome-x-1",               target: "conj-c95",                    type: "introduces" },
  { source: "act-tome-x-1",               target: "conj-c96",                    type: "introduces" },
  { source: "cast-flaxscrip",             target: "concept-hearthold-sovereign", type: "embodies" },
  { source: "cast-genitrix",              target: "concept-hearthold-witness",   type: "embodies" },
  { source: "concept-hearthold-warden",   target: "con-cousin-blades",           type: "references" },
  { source: "concept-hearthold-witness",  target: "concept-dtg-credentials",     type: "requires" },
  { source: "concept-hearthold-sovereign",target: "concept-evidence-graph",      type: "requires" },
  { source: "concept-dtg-credentials",    target: "gateway-archon",              type: "references" },
  { source: "concept-evidence-graph",     target: "concept-dtg-credentials",     type: "relates_to" },
